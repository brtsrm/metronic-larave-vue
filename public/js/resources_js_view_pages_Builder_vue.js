                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.config.header.self.width,
                                expression: "config.header.self.width"
                              }
                            ],
                            staticClass: "form-control",
                            on: {
                      ...
                      _c("div", { staticClass: "col-lg-9 col-xl-4" }, [
                        _c(
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.config.footer.layout,
                                expression: "config.footer.layout"
                              }
                            ],
                            staticClass: "form-control",
                            on: {
                          ...
                          [
                            _c(
                              "option",
                              { attrs: { value: "extended", selected: "" } },
                              [_vm._v("Extended")]
                            ),
                            _vm._v(" "),
                            _c("option", { attrs: { value: "compact" } }, [
                              _vm._v("Compact")
                            ])
                          ]
                        ),
